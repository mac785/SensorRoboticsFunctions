function [thetalist, success, iter] = redundancy_resolution(robot, T_desired, thetalist0, ...
                                                             k0, eomg, ev, max_iter)
...
%   iter      - number of iterations taken
    ...
    for iter = 1:max_iter
        ...
        N = eye(n) - Jb_pinv * Jb;          % projects into null space of J_b
