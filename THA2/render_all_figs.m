...
if ~USE_RST, add_meshes(gca, meshes, mesh_T0, theta_home, robot.Slist, MESH_SCALE, MESH_COLOR, MESH_ALPHA); end
...
if ~USE_RST, add_meshes(gca, meshes, mesh_T0, theta_bent, robot.Slist, MESH_SCALE, MESH_COLOR, MESH_ALPHA); end
...
if ~USE_RST, add_meshes(gca, meshes, mesh_T0, theta_ns, robot.Slist, MESH_SCALE, MESH_COLOR, MESH_ALPHA); end
